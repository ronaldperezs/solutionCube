	...
	<div class="col-md-6">
		<div class="panel panel-primary">
		  <div class="panel-heading">
		    <h1 class="panel-title">Problema Cube Summation!</h1>
		  </div>	  
		  <div class="panel-body">		
		    <div class="jumbotron"> 

			<p>You are given a 3-D Matrix in which each block contains 0 initially. The first block is defined by the coordinate
	 		(1,1,1) and the last block is defined by the coordinate (N,N,N). There are two types of queries.</p>
			...
			<p>calculates the sum of the value of blocks whose x coordinate is between x1 and x2 (inclusive),
			 y coordinate between y1 and y2 (inclusive) and z coordinate between z1 and z2 (inclusive). </p>
		...
		<div class="panel-heading">Solución</div>
		  <div class="panel-body">
		  	<div class="form-group">
		  		<label>Entrada:</label>
		  		<input class="form-control" type="text" id="entrada" name="entrada" />
		  	</div>		    
		    <button id="ejecutar" class="btn btn-success btn-lg" href="#" role="button">Ejecutar</button>
			<button id="reiniciar" class="btn btn-warning btn-lg" href="#" role="button">Reiniciar</button>
		    <br/><br/>
		    <div class="jumbotron">
			  <div class="container">			  
			  <div id="consola"></div>
